...
import { fetchObtenerProducto, fetchBuscarProductos } from "../../Servicio/Api";
...
const ListaProductos = () => {
  ...
  return (
    <div>
      ...
      <div className="max-w-lg mx-auto p-6 rounded-lg bg-white-100 ml-1">
        <form
...
//       .then((data) => {
//         console.log(data); // No se me olvide borrarlo después de probar
//         setProductos(data);
//       })
//       .catch((error) => {
//         console.log(error);
